...
public class MainActivity extends Activity {
    ...
    String server_name = "http://192.168.43.160/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner_author.setAdapter(new ArrayAdapter<String>(this,
                android.R.layout.simple_spinner_item, new String[] { "User1",
    ...
    public void open_chat(View v) {
        ...
        if (author.equals(client)) {
            ...
            // чат не открываем
            Toast.makeText(this, "author = client !", Toast.LENGTH_SHORT).show();
        } else {
    ...
    public void delete_server_chats(View v) {
        ...
        delete_server_chat.setText("Request has been sent...");
    ...
    public void delete_local_chats(View v) {
        ...
        Toast.makeText(getApplicationContext(),
                "Chat on this deviсe is deleted!", Toast.LENGTH_SHORT).show();
    }
    ...
    private class DELETEfromChat extends AsyncTask<Void, Void, Integer> {
        ...
        protected void onPostExecute(Integer result) {
            ...
            try {
                if (result == 200) {
                    Toast.makeText(getApplicationContext(),
                            "Chat on server is deleted!", Toast.LENGTH_SHORT)
                            .show();
                }
            } catch (Exception e) {
                Toast.makeText(getApplicationContext(),
                        "Error! No request sent", Toast.LENGTH_SHORT)
                        .show();
            } finally {
                // сделаем кнопку активной
                delete_server_chat.setEnabled(true);
                delete_server_chat.setText("Remove all chats on server!");
            }
        }
    }
